...
const validationSchema = Yup.object({
  ...
  primaryPh: Yup.string().matches(phoneRegExp, 'Phone number is not valid'),
  secondaryPh: Yup.string().matches(phoneRegExp, 'Phone number is not valid'),
